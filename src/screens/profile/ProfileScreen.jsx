...
import { useCart, useAppUI } from '../../hooks'
...
const ProfileScreen = ({ navigation }) => {
  ...
  // Use dynamic user data from Redux, fallback to mock if null
  const userData = useMemo(() => ({
    name: user?.name || 'User',
    email: user?.email || '',
    phone: user?.phone_no || user?.phone || '',
    profileImage: user?.profile_image_url || require('../../assets/images/ProfileImage.png') // API usually returns image too, but keeping local for now
  }), [user]);
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          <View style={styles.userInfo}>
            ...
            {userData.email ? <Text style={styles.userDetails}>{userData.email}</Text> : null}
            {userData.phone ? <Text style={styles.userDetails}>{userData.phone}</Text> : null}
          </View>
          <Image
