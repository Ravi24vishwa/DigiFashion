...
export const ProductDetails = ({ item = {} }) => {
  const { title = '', fabric = '', SleeveLength = '', Pattern = '' } = item;
  ...
  return (
    <View style={styles.detailsSection}>
      ...
      <View style={styles.detailRow}>
        ...
        <Text style={styles.detailValue}>: {fabric || 'Premium Cotton'}</Text>
      </View>
      {isExpanded && (
        <>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Sleeve</Text>
            <Text style={styles.detailValue}>: {SleeveLength || 'Regular'}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Pattern</Text>
            <Text style={styles.detailValue}>: {Pattern || 'Printed'}</Text>
          </View>
        </>
      )}
